    ...
    <div class="card shadow rounded-4 w-100" style="max-width: 400px;">
        <div class="card-body">
            <div class="text-center mb-3">
                {{-- Logo opcional --}}
                {{-- <img src="/caminho/logo-prefeitura.png" alt="" style="max-height:60px;"> --}}
            </div>
            <h4 class="mb-4 text-center">Área do Candidato</h4>
            <form method="POST" action="{{ route('recurso-pontuacao.login') }}">
                @csrf
                <div class="mb-3">
                    <label>CPF</label>
