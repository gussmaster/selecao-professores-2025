...
<div class="container mt-4">
    ...
    <form method="GET" class="row g-3 mb-4">
        ...
        <div class="col-md-2 align-self-end">
            <a href="{{ route('exportar.csv', request()->query()) }}" class="btn btn-success w-100">Exportar CSV</a>
        </div>
    </form>
    ...
    <table class="table table-bordered table-hover">
        ...
        @foreach($inscricoes as $insc)
            <tr>
                ...
                <td><a href="{{ route('comprovante.pdf', ['id' => $insc->id]) }}" class="btn btn-sm btn-outline-primary">PDF</a></td>
            </tr>
        @endforeach
        </tbody>
    </table>
