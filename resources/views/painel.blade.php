...
<head>
    ...
    <a href="{{ route('relatorio') }}" class="btn btn-outline-primary">📊 Relatório</a>
    <a href="{{ route('pontuacao.buscar') }}" class="btn btn-outline-dark">🧮 Atribuir Pontuação</a>
...
<body>
    ...
    <div class="container mt-4">
		...
		<span class="badge bg-info text-dark">Total de inscritos: {{ $totalInscritos }}</span>
