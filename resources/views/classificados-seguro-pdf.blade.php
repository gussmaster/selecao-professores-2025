...
<body>
    ...
    <div class="titulo">
        RESULTADO FINAL DA PRIMEIRA ETAPA - ANÁLISE DE TÍTULOS<br>
       <!-- <span style="font-size:13px; font-weight:normal;">(Exportado em {{ $dataExportacao }})</span>-->
    </div>
    ...
    <table>
        ...
        @foreach($inscricoes as $idx => $i)
            <tr>
                ...
                <td style="text-align: center">{{ $i->pontuacao }}</td>
		<td>{{ $i->cargo }}</td>
            </tr>
        @endforeach
        </tbody>
